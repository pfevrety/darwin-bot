...
module.exports = {
    ...
    options: [
        {
            name: "target",
            description: "The tempban target",
            type: 6,
            required: true,
            choices: []
        },
        {
            name: "time",
            description: "The tempban time in days",
            type: 4,
            required: true,
            choices: []
        },
        {
            name: "reason",
            description: "The reason of the tempban",
            type: 3,
            required: false,
            choices: []
        }
    ...
    run: async (interaction, args) => {
        ...
        const time = interaction.options.getInteger('time') >= 7 ? 7 : interaction.options.getInteger('time');
